...
from ultron.health.observability import build_latency_snapshot, record_latency_metric, record_runtime_event
...
class ObservabilityLatencyTests(unittest.TestCase):
    def test_record_latency_metric_writes_structured_runtime_event(self):
        with TemporaryDirectory() as tmp:
            ...
            with patch("ultron.health.observability.EVENT_LOG", event_log):
