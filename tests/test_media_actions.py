...
class MediaActionsTests(unittest.TestCase):
    ...
    def test_media_actions_execute_playback_controls_and_volume(self):
        ...
        client.devices.return_value = {"devices": [{"id": "dev-1", "is_active": True}]}
        spoken = []
        ...
        client.start_playback.assert_called_once_with(device_id="dev-1")
        client.pause_playback.assert_called_once_with(device_id="dev-1")
        client.next_track.assert_called_once_with(device_id="dev-1")
        client.previous_track.assert_called_once_with(device_id="dev-1")
        client.volume.assert_called_once_with(100, device_id="dev-1")
    ...
    def test_media_search_and_current_playback_success_and_empty_states(self):
        ...
        client.start_playback.assert_called_once_with(uris=["spotify:track:1"], device_id="dev-1")
