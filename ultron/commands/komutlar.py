"""COMMANDS - All ULTRON commands."""

from __future__ import annotations

from time import perf_counter

from ultron.audio.ses_motoru import speak
from ultron.commands.action_dispatcher import execute_action as dispatch_execute_action
from ultron.commands.groq_router import analyze_with_groq, summarize_text, translate_text
from ultron.commands.local_intent_router import route_local_intent
from ultron.health.observability import record_latency_metric
from ultron.memory import add_to_short_term, detect_and_save_preference, track_command
...
def process_command(command: str) -> bool:
    ...
    if any(k in command for k in ["goodbye ultron", "shut down ultron", "goodbye jarvis", "shut down jarvis"]):
        speak("Farewell, sir. Ultron shutting down.")
        return False
