...
from ultron.ui.ui_dialogs import ReadmeDialog
...
class OnboardingWizard(ctk.CTkToplevel):
    ...
    def __init__(self, master, on_complete=None):
        ...
        self.title("ULTRON Setup Wizard")
    ...
    def _build_ui(self):
        ...
        ctk.CTkButton(footer, text="Recheck", fg_color=BLUE_DIM, hover_color="#7a1220", command=self._render).pack(side="left")
