"""Secondary cockpit pages for the ULTRON desktop UI."""
...
from ultron.runtime.config_runtime import resolved_env
...
def _build_page_values(page_key: str) -> dict[str, tuple[str, str, str]]:
    ...
    if page_key == "integrations":
        ...
        return {
            ...
            "Weather service": ("READY", "Open-Meteo, no key needed - set JARVIS_WEATHER_CITY to override IP location", PALETTE["green"]),
    ...
    return {
        ...
        "Wake word": (env.get("JARVIS_WAKE_WORD", "ultron").upper(), "Assistant activation phrase", PALETTE["cyan"]),
