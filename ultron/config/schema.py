...
FIELD_DEFINITIONS: dict[str, FieldDefinition] = {
    ...
    "ai.cloud_provider": FieldDefinition(
        "ai.cloud_provider", "string", "none", env_var="JARVIS_CLOUD_PROVIDER", allowed_values=("none", "groq")
    ),
    "ai.cloud_fallback_enabled": FieldDefinition(
        "ai.cloud_fallback_enabled", "bool", False, env_var="JARVIS_CLOUD_FALLBACK_ENABLED"
    ),
